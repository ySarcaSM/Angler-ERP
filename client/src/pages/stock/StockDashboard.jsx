...
export default function StockDashboard() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Estoque" subtitle="Controle de movimentações" action={<button onClick={() => setModal(true)} className="btn-primary"><Plus size={18} /> Ajustar Estoque</button>} />
      {summary && (
